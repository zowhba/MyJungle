...
public class PlayerBigdogInfo extends AllUnit{
    public PlayerBigdogInfo(float x, float y, int team){
        this.unitNumber = 5;
        this.imageWidth = 128;
        ...
        this.attackCooltimeMax = 10;
        this.attackState = 1;
        this.attackStateMax = 5;
        this.dieStateMax = 50;
        this.food = 200;
        this.purchaseGold = 100000;
